...
- 1080×1440 PNG 中秋賀卡：1 種版型、4 種依成績變化的稱號，放大樂衍祝福，不含 QR Code。
...
核心遊戲邏輯 10 項測試通過（初版另有 QR 測試，QR 已依需求移除）；Chrome 實際一局完成、圖卡生成、左右移動與結算已驗證。手機尺寸以瀏覽器 viewport 模擬檢查；iOS／Android 原生分享選單需實機確認。
